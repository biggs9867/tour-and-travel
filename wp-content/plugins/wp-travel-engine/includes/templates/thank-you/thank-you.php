...
<div class="thank-you-container">
	...
	<div class="detail-container">
		...
		if ( is_array( $booking->payments ) && count( $booking->payments ) ) {
			foreach ( $booking->payments as $index => $pid ) {
				...
				<div class="detail-item">
					...
					<span class="value"><?php echo wte_esc_price( wte_get_formated_price( $payment_amount, '', '', false, false, true ) ) . " <code>[" . esc_html__( $payment_obj->payment_status, 'wp-travel-engine' ) . "]</code>"; ?></span>
				</div>
				<?php
			}
		}
		...
		<div class="detail-item">
			...
			<?php
			echo wp_kses(
				"<code>[".esc_html__($payment->payment_status, 'wp-travel-engine')."]</code>",
