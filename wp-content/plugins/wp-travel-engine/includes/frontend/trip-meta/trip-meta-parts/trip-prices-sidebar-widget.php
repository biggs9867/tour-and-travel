...
<div class="widget wpte-bf-outer <?php echo esc_attr( $wrapper_classes ); ?>">
	...
	<div class="wpte-booking-area">
		<button type="button" id="wpte_price-toggle-btn-mb" class="wpte_price-toggle-btn-mb" data-active-text="<?php _e( 'Hide Prices', 'wp-travel-engine' ); ?>"><span class="current-text">
