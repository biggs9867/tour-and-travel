...
//Removing Trip Facts Title from the trip-content
add_action( 'wp_travel_engine_trip_facts_title', '__return_false' );

if( ! function_exists( 'travel_monster_single_header_trip_facts' ) ) :
/**
 * Single-Trip Content Facts
 * 
 * @package Travel monster Pro
*/
function travel_monster_single_header_trip_facts(){
    do_action( 'wp_travel_engine_trip_facts' );
}
endif;
add_action( 'wp_travel_engine_before_trip_tabs', 'travel_monster_single_header_trip_facts',20 );
